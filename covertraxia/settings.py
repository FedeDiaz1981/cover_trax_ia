...
SECRET_KEY = 'django-insecure-9krlf(t#^5v6pu)0c#eezw^h&@_2k(+*!8&8@4yaj^z7ta!z_c'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = os.getenv("ALLOWED_HOSTS", "127.0.0.1,localhost,fede3100.pythonanywhere.com").split(",")
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tienda.context_processors.carrito_total',
            ],
        },
    },
]

WSGI_APPLICATION = 'covertraxia.wsgi.application'

LOGIN_URL = '/login/'

LOGIN_REDIRECT_URL = '/admin-productos/'
...
SESSION_COOKIE_AGE = 86400  # Tiempo de sesión en segundos (1 día)
